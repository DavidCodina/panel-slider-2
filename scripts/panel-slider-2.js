...
function indicate_slide(index){
  ...
  //
  //        slices[i].classList.remove("slide-out-right");
  //        slices[i].classList.remove("slide-out-left");
  //
  //
  ...
  for (let i = 0; i < slices.length; i++) {
    slices[i].classList.add("slide-out-right");
    slices[i].classList.add("slide-out-left");
  }
  ...
  for (let i = 0; i < slice_containers.length; i++){
    ...
    slice.classList.remove("slide-out-right");
    slice.classList.remove("slide-out-left");
